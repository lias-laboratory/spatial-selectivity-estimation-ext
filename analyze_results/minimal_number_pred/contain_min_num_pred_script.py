...
# %%
models_dir = "/home/adminlias/nadir/Spatial-Selectivity-Ext/large_files/LearnedModels/contain"
...
for model_type, datasets in max_models.items():
    ...
    for dataset, info in datasets.items():
        ...
        # Save results to CSV
        results_df.to_csv("contain_min_y_experiment_results_20.csv", index=False)
